...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/Fitunnel/AutoScriptLite/main/"
...
echo -e "\e[32mloading...\e[0m" 
clear
izinsc="https://raw.githubusercontent.com/Fitunnel/AutoScriptLite/main/register"
# USERNAME
rm -f /usr/bin/user
...
bash -c "$(curl -L https://github.com/XTLS/Xray-install/raw/main/install-release.sh)" @ install -u www-data --version $latest_version
    ...
    # // Ambil Config Server
    # Hide For SSH wget -O /etc/xray/config.json "${REPO}config/config.json" >/dev/null 2>&1
...
# Xray Hident wget -q https://raw.githubusercontent.com/Fitunnel/AutoScriptLite/main/config/fv-tunnel && chmod +x fv-tunnel && ./fv-tunnel
...
# Hiden IP Server wget -q -O /etc/ipserver "${REPO}files/ipserver" && bash /etc/ipserver
